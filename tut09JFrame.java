...
public class tut09JFrame extends JFrame implements Runnable {
	...
	public tut09JFrame(){
		...
		this.addWindowListener(new tut09OyenteVentana(this));
		this.addKeyListener(new tut09OyenteTeclado(this));
		this.addMouseMotionListener(new tut09OyenteMouseMovimiento(this));
		this.addMouseListener(new tut09OyenteMouse(this));
	...
	public static void main(String[] args) {
		tut09JFrame ventana = new tut09JFrame();
	}
